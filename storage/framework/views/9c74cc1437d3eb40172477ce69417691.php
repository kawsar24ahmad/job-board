...
/>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('admin/vendors/ti-icons/css/themify-icons.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/js/select.dataTables.min.css')); ?>">
...
<body>
  ...
  <?php echo $__env->make('layouts.partials.company-navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- partial -->
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial -->
    <?php echo $__env->make('layouts.partials.company-sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <script src="<?php echo e(asset('admin/js/dataTables.select.min.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('admin/js/Chart.roundedBarCharts.js')); ?>"></script>
  <!-- End custom js for this page-->
</body>

</html>

<?php /**PATH F:\laravelcareerpathCourse\assignments\team-project\test\job-board\resources\views/layouts/company-layout.blade.php ENDPATH**/ ?>